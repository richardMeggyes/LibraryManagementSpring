...
public interface DeviceRecordsRepository extends JpaRepository<DeviceRecord, Integer> {
//    Optional<DeviceRecord> findByDevice(Device device);

    //    DeviceRecord findByDeviceOrOrderByIdDesc(int id);
    DeviceRecord findTopByDevice(Device device);
